...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
        ...
        <li class="start active ">
					<a href="{{route('reportallcategory')}}">
					<i class="icon-home"></i>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="{{route('reportallmedicine')}}">Medicines With Jquery</a>
						</li>
						<li>
							<a href="{{route('reportlistallmedicines')}}">
							List All Medicines</a>
						</li>
					</ul>
				</li>
				...
				<li >
					<a href="javascript:;">
					<i class="icon-docs"></i>
					<span class="title">Master Create</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
							<a href="{{route('kategori.create')}}">Create New Category</a>
						</li>
						<li>
							<a href="{{route('medicine.create')}}">
							Create New Medicine</a>
						</li>
					</ul>
				</li>
	...
	<div class="page-content-wrapper">
			...
			<div class="page-content">
				{{-- TODO nanti akan menambahkan sebuah syntax --}}
				{{-- harus satu --}}
				@yield('content')
